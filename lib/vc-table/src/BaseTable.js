...
var BaseTable = {
  ...
  props: {
    ...
    hasSummary: _vueTypes2['default'].bool,
  ...
  render: function render() {
    ...
    var _$props2 = this.$props,
        ...
        hasSummary = _$props2.hasSummary,
    ...
    return h(
      ...
      }), body, hasSummary && h(_TableHeader2['default'], {
        attrs: { isSummary: true, expander: expander, columns: columns, fixed: fixed }
      })]
    );
  }
};
