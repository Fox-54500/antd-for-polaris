...
export default {
  ...
  render: function render() {
    ...
    var _table2 = this.table,
        ...
        useFixedSummary = _table2.useFixedSummary;
    ...
    var bodyTableClassName = prefixCls + '-body';
    if (hasSummary) {
      var _scrollbarWidth = measureScrollbar();
      if (_scrollbarWidth > 0) {
        bodyStyle.marginBottom = '-' + _scrollbarWidth + 'px';
        bodyStyle.paddingBottom = '0px';
      }
    }
    return h(
